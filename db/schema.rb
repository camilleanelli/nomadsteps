...
ActiveRecord::Schema.define(version: 20161213115935) do
  ...
  create_table "transportations_users", id: false, force: :cascade do |t|
    t.integer "transportation_id", null: false
    t.integer "user_id",           null: false
    t.index ["transportation_id", "user_id"], name: "index_transportations_users_on_transportation_id_and_user_id", using: :btree
    t.index ["user_id", "transportation_id"], name: "index_transportations_users_on_user_id_and_transportation_id", using: :btree
  end
